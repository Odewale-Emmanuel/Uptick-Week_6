...
export async function getServerSideProps() {
  // Simulate fetching initial data, like user info or form settings
  // user, authToken, tokenNotFound, invalidToken, notes, loadingNote;
  const cookie = await cookies();
  const initialData = cookie.getAll();
...
function Dashboard({ initialData }: { initialData: any }): JSX.Element {
